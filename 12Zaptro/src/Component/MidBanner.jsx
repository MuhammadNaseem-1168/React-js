...
const MidBanner = () => {
  return (
    <div className="bg-gray-100 md:py-24">
      <div
        className="relative max-w-7xl mx-auto md:rounded-2xl pt-28 bg-cover bg-center h-138 md:h-150"
        style={{
      ...
      >
        <div className="absolute inset-0 bg-black/60 md:rounded-2xl bg-opacity-50 flex items-center justify-center">
          <div className="text-center text-white px-4">
            <h1 className="text-3xl md:text-xl lg:text-6xl font-bold mb-4">
              Next-Gen Electronics at your Fingertips
            </h1>
            <p className="text-lg md:text-xl mb-6">
              Discover the Intest tech innovation wuth unbeatable prices and
