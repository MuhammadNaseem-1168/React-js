              ...
              {cartItem.map((item, index) => {
                return (
                  ...
                  >
                    ...
                    <div className="bg-red-500 text-white flex gap-4 rounded-md font-bold p-2 text-xl">
                      <button
                        onClick={() =>
            ...
            <div className="grid grid-cols-2 gap-20">
              <div className="bg-gray-100 rounded-md p-7 mt-4 space-y-2">
                ...
                <div className="flex justify-center ">
                  <button className="bg-red-500  text-white px-3 py-2 rounded-md cursor-pointer hover:bg-red-800">
                    Detect Location
                  </button>
                </div>
              </div>
              ...
              <div className="bg-white border border-gray-100 shadow-xl rounded-md p-7 mt-4 space-y-2 h-max">
                ...
                <div>
                  ...
                  <div className="flex gap-3">
                    ...
                    />
                    <button className="bg-white text-black border border-gray-200 px-4 cursor-pointer py-1 rounded-md hover:bg-blue-700 hover:text-white">
                      Apply
                    </button>
                  </div>
                </div>
                <button className="bg-red-500 text-white px-3 py-2 rounded-md w-full cursor-pointer hover:bg-red-800">
                  Proceed to Checkout
                </button>
              </div>
            </div>
